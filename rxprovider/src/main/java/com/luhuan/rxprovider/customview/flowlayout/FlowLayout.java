package com.luhuan.rxprovider.customview.flowlayout;
...
import com.luhuan.rxprovider.customview.flowlayout.logic.CommonLogic;
import com.luhuan.rxprovider.customview.flowlayout.logic.ConfigDefinition;
import com.luhuan.rxprovider.customview.flowlayout.logic.LineDefinition;
import com.luhuan.rxprovider.customview.flowlayout.logic.ViewDefinition;
...
public class FlowLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            @SuppressLint("DrawAllocation") ViewDefinition view = new ViewDefinition(this.config, child);
